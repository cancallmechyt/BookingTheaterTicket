 ...
 * @author chima
 */
public class Movie_Ticket5 extends javax.swing.JFrame {

    /**
     * Creates new form Movie_Ticket
     */
    String seatbuy ="";
    public Movie_Ticket5() {
        initComponents();
    ...
    Movie_Ticket5(String seats, int total) {
        
    }

    Movie_Ticket5(String seats, int total, String usermovie1) {
        this();
        test.setText(seats);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/ticket05.png"))); // NOI18N
    ...
    private void btsaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btsaveMouseClicked
        ...
        try{
           ...
           Writer.write(user+" "+SEAT+" "+"Movie : Kung Fu Panda "+NewLine);
           Writer.close();
           //End Writer File..............................
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Movie_Ticket5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Movie_Ticket5().setVisible(true);
            }
        });
    }
