 ...
 * @author chima
 */
public class Movie_Ticket6 extends javax.swing.JFrame {

    /**
     * Creates new form Movie_Ticket
     */
    String seatbuy ="";
    public Movie_Ticket6() {
        initComponents();
    ...
    Movie_Ticket6(String seats, int total) {
        
    }

    Movie_Ticket6(String seats, int total, String usermovie1) {
        this();
        test.setText(seats);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/ticket06.png"))); // NOI18N
    ...
    private void btsaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btsaveMouseClicked
        ...
        try{
           ...
           Writer.write(user+" "+SEAT+" "+"Movie : IT Chapter Two(2) "+NewLine);
           Writer.close();
           //End Writer File..............................
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Movie_Ticket6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Movie_Ticket6().setVisible(true);
            }
        });
    }
