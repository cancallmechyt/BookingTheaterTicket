 ...
 * @author chima
 */
public class Movie_Ticket11 extends javax.swing.JFrame {

    /**
     * Creates new form Movie_Ticket
     */
    String seatbuy ="";
    public Movie_Ticket11() {
        initComponents();
    ...
    Movie_Ticket11(String seats, int total) {
        
    }

    Movie_Ticket11(String seats, int total, String usermovie1) {
        this();
        test.setText(seats);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/ticket11.png"))); // NOI18N
    ...
    private void btsaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btsaveMouseClicked
        ...
        try{
           ...
           Writer.write(user+" "+SEAT+" "+"Movie : Toy Story 1 "+NewLine);
           Writer.close();
           //End Writer File..............................
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Movie_Ticket11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Movie_Ticket11().setVisible(true);
            }
        });
    }
