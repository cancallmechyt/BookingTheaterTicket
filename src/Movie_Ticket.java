 ...
 * @author chima
 */
public class Movie_Ticket extends javax.swing.JFrame {
    ...
    Movie_Ticket(String seats, int total) {
        
    }

    Movie_Ticket(String seats, int total, String usermovie1) {
        this();
        test.setText(seats);
    ...
    private void btsaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btsaveMouseClicked
        ...
        try{
           ...
           Writer.write(user+" "+SEAT+" "+"Movie : Joker "+NewLine);
           Writer.close();
           //End Writer File..............................
