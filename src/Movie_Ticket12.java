 ...
 * @author chima
 */
public class Movie_Ticket12 extends javax.swing.JFrame {

    /**
     * Creates new form Movie_Ticket
     */
    String seatbuy ="";
    public Movie_Ticket12() {
        initComponents();
    ...
    Movie_Ticket12(String seats, int total) {
        
    }

    Movie_Ticket12(String seats, int total, String usermovie1) {
        this();
        test.setText(seats);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/ticket12.png"))); // NOI18N
    ...
    private void btsaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btsaveMouseClicked
        ...
        try{
           ...
           Writer.write(user+" "+SEAT+" "+"Movie : Frozen 2 "+NewLine);
           Writer.close();
           //End Writer File..............................
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Movie_Ticket12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Movie_Ticket12().setVisible(true);
            }
        });
    }
